...
export function SectionPage({ section, programs, activities, onOpenUniversity }: { section: Section; programs: Program[]; activities: Activity[]; onOpenUniversity: (id: number) => void }) {
