  ...
  async function submit(event: React.FormEvent) {
    ...
    try {
      ...
      if (editing) {
        ...
        setMessage('Роль и доступ пользователя обновлены.'); setEditing(null)
      } else {
        const link = await onCreate(form)
        setInvitation(link); setCreating(false); setMessage('Пользователь создан. Передайте ему персональную ссылку.')
      }
