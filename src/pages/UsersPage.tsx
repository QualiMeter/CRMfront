...
export function UsersPage({ users, universities, onCreate, onUpdate }: {
  ...
  return <div className="content users-workspace">
    <div className="page-heading"><div><div className="eyebrow">ДОСТУП И РОЛИ</div><h1>Пользователи</h1><p className="muted">Управление сотрудниками и доступом к данным учебных заведений</p></div><button className="primary-button" onClick={openCreate}><Icon name="plus" size={17} /> Добавить пользователя</button></div>
