...
export function UniversityDetailsPage({ data, universities, onSwitch, programId, onSelectProgram, onSaveStage, onUploadStageAttachment, onDeleteStageAttachment, onCreateTask, onUpdateTask, onOpenPrograms, requiresStatusApproval = false }: {
