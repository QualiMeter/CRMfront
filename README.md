...
Исправлено жёсткое ограничение минимальной ширины страницы 1180 px. Дополнительные адаптивные правила находятся в `src/responsive.css`, подключённом после основного стиля. Фильтр статусов в списке вузов теперь работает совместно с поиском.
